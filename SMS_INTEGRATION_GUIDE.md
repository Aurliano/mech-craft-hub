...
# شناسه قالب برای اعلان سفارش ساخت/تولید به پیمانکار (اختیاری، توصیه‌شده)
SMS_TEMPLATE_ID_MANUFACTURING_ORDER=533869

# شناسه قالب برای تایید کارگاه پیمانکار (اختیاری، توصیه‌شده)
SMS_TEMPLATE_ID_APPROVE_WORKSHOP=294329
```
...
### 3. نمونه قالب اعلان سفارش ساخت/تولید برای پیمانکار

متن پیشنهادی در پنل SMS.ir:

```
سلام #CONTRACTOR# عزیز،
...
توجه: نام متغیر در پنل باید دقیقاً `CONTRACTOR` باشد تا با پیاده‌سازی فعلی هماهنگ باشد.

### 4. نمونه قالب تایید کارگاه برای پیمانکار

شناسه قالب: `294329`  
عنوان: `approve_workshop`
...
درخواست شما برای ثبت کارگاه #WORKSHOP# مورد تایید قرار گرفت.
```

توجه: نام متغیر در پنل باید دقیقاً `WORKSHOP` باشد تا با پیاده‌سازی فعلی هماهنگ باشد.
