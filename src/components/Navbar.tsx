              ...
              <NavigationMenuList className="gap-2" dir="rtl">
                ...
                <NavigationMenuItem dir="rtl">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent 
                      align="end" 
                      className="w-[280px] p-2 bg-white border border-gray-200 shadow-lg"
                      sideOffset={5}
                    >
                        ...
                        {services.map((service, index) => (
                          <React.Fragment key={service.name}>
                            {service.subItems ? (
                              <DropdownMenuSub>
                                <DropdownMenuSubTrigger 
                                  className="flex items-center justify-between w-full bg-gray-50 hover:bg-gray-100 text-foreground px-3 py-2 rounded-md transition-colors"
                                >
                                  <span>{service.name}</span>
                                  <Plus className="h-3 w-3" />
                                </DropdownMenuSubTrigger>
                                <DropdownMenuSubContent 
                                  className="w-[260px] bg-gray-50 border border-gray-200 shadow-lg"
                                >
                                    ...
                                    {service.subItems.map((subItem) => (
                                      <React.Fragment key={subItem.name}>
                                        {subItem.subItems ? (
                                          <DropdownMenuSub>
                                            <DropdownMenuSubTrigger 
                                              className="flex items-center justify-between w-full bg-gray-100 hover:bg-gray-200 text-foreground px-3 py-2 rounded-md transition-colors text-sm"
                                            >
                                              <span>{subItem.name}</span>
                                              <Plus className="h-3 w-3" />
                                            </DropdownMenuSubTrigger>
                                            <DropdownMenuSubContent 
                                              className="w-[240px] bg-gray-100 border border-gray-300 shadow-lg"
                                            >
                                              <div className="space-y-1 p-1" dir="rtl">
                                                {subItem.subItems.map((thirdLevel) => (
                                                  <DropdownMenuItem 
                                                    key={thirdLevel.name} 
                                                    asChild
                                                    className="bg-gray-200 hover:bg-gray-300 text-foreground px-3 py-2 rounded-md transition-colors text-xs"
                                                  >
                                          ...
                                          <DropdownMenuItem 
                                            asChild
                                            className="bg-gray-100 hover:bg-gray-200 text-foreground px-3 py-2 rounded-md transition-colors text-sm"
                                          >
                              ...
                              <DropdownMenuItem 
                                asChild
                                className="bg-gray-50 hover:bg-gray-100 text-foreground px-3 py-2 rounded-md transition-colors"
                              >
                            ...
                            {index < services.length - 1 && <DropdownMenuSeparator className="my-1 bg-gray-200" />}
                          </React.Fragment>
                        ))}
                      </div>
                    </DropdownMenuContent>
