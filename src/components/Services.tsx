  ...
  const servicesList = [
    {
      ...
      description: "طراحی قطعات و سیستم‌های مکانیکی با استفاده از نرم‌افزارهای پیشرفته ",
    ...
    },
    {
      ...
      features: ["تحلیل سیستم های مکانیکی", "تحلیل دینامیکی، استاتیکی و حرارتی", "حل عددی", "بهینه‌سازی عملکرد"],
      href: "/analysis"
    },
    {
      icon: FileText,
      ...
      features: ["نقشه‌کشی فنی", "جزئیات ساخت", "تلرانس های GD&T", "استانداردسازی"],
      href: "/drawing"
    },
    {
      icon: Settings,
      title: "ساخت و تولید",
      description: "ساخت و تولید قطعات صنعتی با بالاترین کیفیت و دقت",
      features: ["ماشین‌کاری CNC", "اجرای فرآیند های متالورژی", "کنترل کیفیت", "مونتاژ و تست"],
      href: "/manufacturing"
    }
  ];

  return (
    <section id="services" className="py-10 md:py-16 bg-gradient-subtle">
            ...
            return (
              <Card key={index} className="group hover:shadow-elegant transition-all duration-300 hover:-translate-y-2 bg-card border-border">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-foreground text-center">{service.title}</CardTitle>
