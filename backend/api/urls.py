...
from .views import (
    ...
    customer_register, contractor_register, specialist_register, login, refresh_token, logout, me, update_my_profile, UserViewSet, UploadView,
    ...
    initiate_payment_project_phase,
...
urlpatterns = [
    ...
    path('v1/auth/me/update/', update_my_profile, name='update_my_profile'),
    ...
    path('v1/orders/<uuid:order_id>/payments/phase/<int:phase>/', initiate_payment_project_phase, name='initiate_payment_project_phase'),
