#!/usr/bin/env python
"""
Script to create sample blog posts for the Sayda Engineering Platform
"""
...
نقشه‌کشی صنعتی مهارتی است که نیاز به تمرین مداوم و به‌روزرسانی دانش دارد. با پیشرفت فناوری، روش‌های نقشه‌کشی نیز در حال تغییر است.''',
    ...
    print(f"\nTotal posts created: {len(created_posts)}")
    print(f"Total posts in database: {BlogPost.objects.count()}")
