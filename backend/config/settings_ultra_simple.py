...
SMS_TEMPLATE_ID_MANUFACTURING_ORDER = os.getenv('SMS_TEMPLATE_ID_MANUFACTURING_ORDER')
SMS_TEMPLATE_ID_APPROVE_WORKSHOP = os.getenv('SMS_TEMPLATE_ID_APPROVE_WORKSHOP')
